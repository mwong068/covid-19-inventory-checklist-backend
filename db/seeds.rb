...
dude = HelpfulUser.create(name: "Nice Guy", username: "niceguy4", password_digest: "helpfulguy", email: "trying_to_be_helpful@gmail.com", location: "San Francisco", family_size: 4, has_children: true, can_deliver: true)
